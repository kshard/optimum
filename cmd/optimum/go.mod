module github.com/kshard/optimum/cmd/optimum
...
require (
	...
	github.com/fogfish/gurl/x/awsapi v0.0.5
	github.com/fogfish/schemaorg v1.28.0
...
require (
	...
	github.com/kshard/wreck v0.0.3 // indirect
